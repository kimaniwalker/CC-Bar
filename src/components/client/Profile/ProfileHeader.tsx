    ...
    <div className="rounded-3xl bg-white p-6 shadow-sm">
      <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex justify-between flex-col gap-2">
          ...
          <Text
            size="sm"
            className=" max-w-lg text-sm leading-7 text-neutral-500"
          >
            Welcome Back {user?.email} As a member, enjoy thoughtfully curated
            rewards and exclusive offers.
          </Text>
        </div>

        <div className="grid grid-cols-3 gap-3">
          <div className="rounded-2xl border border-neutral-200 bg-[#F8F5F1] px-5 py-4 text-center flex flex-col items-center justify-center shrink-0 min-w-20">
          ...
          <Suspense
            fallback={
              <div className="rounded-2xl border border-neutral-200 bg-[#F8F5F1] px-5 py-4 text-center relative animate-pulse flex flex-col items-center justify-center">
                <BadgeDollarSign
                  fill="#d6e232"
