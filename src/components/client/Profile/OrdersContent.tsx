  ...
  return (
    <section className="rounded-3xl bg-white p-6 shadow-sm">
      <div className="flex items-center justify-between">
        <div>
          <Text size="lg" className="text-xl font-semibold">
            Recent Orders
          </Text>
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="rounded-full border border-neutral-300 px-4 py-2 text-xs font-medium transition hover:bg-neutral-100"
              >
